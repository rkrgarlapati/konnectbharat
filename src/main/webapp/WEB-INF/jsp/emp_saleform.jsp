...
<form:form id="sale_form" class="sale_form_class" method="POST"
           action="/saleAgreementupdated/${saId}" commandName="saleAttributes">
    <div id="sales_form" class="container-fluid">
        ...
        <c:if test="${activate == 'activate'}">
            <input type="button" id="submit_sale_update"
        ...
        <c:if test="${activate == 'activate'}">
            <input type="button" id="submit_sale_activate"
                   class="btn  btn-primary"
    ...
    <input type="hidden" id="salepopupflg" value="true">
