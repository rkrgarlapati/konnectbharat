...
<div id="sidebar" class="col-sm-2 no-float nav-parent well sidebar-nav"
	...
	<ul class="nav nav-pills nav-stacked">
		...
		<li><a href="/viewContacts?pageid=2" title="Title"><spring:message
					code="menu_outbound" /></a></li>
		<li><a href="/viewContacts?pageid=3" title="Title"><spring:message
